                  ...
                  <div className="flex gap-2 relative z-10">
                    {post.tags?.map((tag: string) => (
                      <Link
                        ...
                        className="text-[10px] uppercase tracking-widest border border-border-subtle px-2 py-0.5 rounded text-muted hover:border-blue-400 hover:text-blue-400 transition-colors font-mono"
                      >
                        #{tag}
                      </Link>
                    ))}
